## angles (jazzy) - 1.16.0-6

The packages in the `angles` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --override-release-repository-push-url git@github.com:tgenovese/angles-release.git angles` on `Mon, 28 Jul 2025 17:22:56 -0000`
...
## angles (rolling) - 1.16.0-1

The packages in the `angles` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling angles` on `Tue, 12 Jul 2022 07:34:03 -0000`
...
## angles (galactic) - 1.14.0-1

The packages in the `angles` repository were released into the `galactic` distro by running `/usr/bin/bloom-release --track galactic --rosdistro galactic angles` on `Tue, 12 Jul 2022 07:19:37 -0000`
...
- upstream repository: https://github.com/ros/angles.git
- release repository: https://github.com/ros2-gbp/angles-release.git
- rosdistro version: `1.12.4-2`
- old version: `1.12.4-2`
...
## angles (foxy) - 1.12.6-1

The packages in the `angles` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --track foxy --rosdistro foxy angles` on `Tue, 12 Jul 2022 07:12:17 -0000`
...
## angles (foxy) - 1.12.5-1

The packages in the `angles` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --track foxy --rosdistro foxy angles` on `Sun, 10 Jul 2022 23:01:31 -0000`
...
- upstream repository: https://github.com/ros/angles.git
- release repository: https://github.com/ros2-gbp/angles-release.git
- rosdistro version: `1.12.3-1`
- old version: `1.12.3-1`
...
## angles (rolling) - 1.13.0-1

The packages in the `angles` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling angles` on `Tue, 18 Jan 2022 21:49:18 -0000`
...
- upstream repository: https://github.com/ros/angles.git
- release repository: https://github.com/ros2-gbp/angles-release.git
- rosdistro version: `1.12.4-1`
- old version: `1.12.4-1`
